...
<style>
	...
	.swe-team-layout-1 .profile h1{
		   font-size: <?php _e( $team_name_font_size_17 );?>px;
		   color: <?php _e( $theme_color );?>;
    }
    .swe-team-layout-1 .profile .img-box:after {
		background-color: <?php _e( $hovercolor ); ?>;
	}
	.swe_team_carousel_layout .owl-nav div{
		background:  <?php _e( $theme_color ); ?>;
	}
	...
	.swe-team-layout-1 .img-box ul li{
		border-color: <?php _e( $theme_color );?>;
	}
	...
	.swe-team-layout-2 .team-member:hover .member-info {
		background-color:  <?php _e( $theme_color );?>;
	}
	...
	.swe-team-layout-4 .single-team-member .thumbnail-image {
		border: 2px solid <?php _e( $theme_color )?>;
	}
	...
	.swe-team-layout-8 .team-info {
		color: <?php _e( $theme_color );?>;
		border-bottom: 3px solid <?php _e ( $theme_color );?>;
	}
...
<script>
	jQuery(window).load(function(){
		jQuery(".owl-carousel").owlCarousel({
				loop: <?php _e( $carousel_loop_0 )?>,
				dots: <?php _e( $pagination_1 )?>,
				nav:<?php _e( $navigation_2 )?>,
				navText:["‹","›"],
				autoplay: <?php _e( $autoplay_4 )?>,
				autoplayHoverPause: <?php _e( $autoplay_pause_on_hover_6 )?>,
				autoplayTimeout:<?php _e( $autoplay_timeout_7 )?>,
				margin:<?php _e( $margin_8 )?>,
				responsiveClass:true,
				responsive : {0 : {items: <?php _e( $columns_in_mobile_11 )?>},768 : {items: <?php _e( $columns_in_table_10 )?>},960 : {items: <?php _e( $columns_in_table_10 )?>},
				1200 : {items: <?php _e( $columns_in_desktop_9 )?>},1920 : {items: <?php _e( $columns_in_desktop_9 )?>}
			}
		});
	});
...
<div class="preview_layout_1">
	<div class="text-shortcode-wrap">
		<span class="shortcode_name">Shortcode for Team Carousel layout 1</span>		
		<input type="text" value="[swe-team layout=1]" readonly onclick="copythis()" class="copy_shortcode">
		<span class="shortcode_info">Use this Shortcode in any post/page/widget </span>
	</div>
	<div class="swe-team-layout-1 owl-carousel swe_team_carousel_layout" id="swe-preview-layout1" >
			<div class="single-team-member profile">
			<div class="img-box">
			<?php _e( '<img src="' . esc_url( plugins_url( 'img/team1.jpg', __FILE__ ) ) . '" > ' ); ?>
		...
		<div class="single-team-member profile">
			<div class="img-box">
			<?php _e( '<img src="' . esc_url( plugins_url( 'img/team2.jpg', __FILE__ ) ) . '" > ' ); ?>
				<?php if($show_hide_social_connection_15 == "true") { ?>	
					<ul class="text-center">
						<a href="https://facebook.com"><li><i class="fa fa-facebook"></i></li></a>
						<a href="https://twitter.com"><li><i class="fa fa-twitter"></i></li></a>
		...
		<div class="single-team-member profile">
			<div class="img-box">
			<?php _e( '<img src="' . esc_url( plugins_url( 'img/team3.jpg', __FILE__ ) ) . '" > '); ?>
				<?php if($show_hide_social_connection_15 == "true") { ?>	
					<ul class="text-center">
						<a href="https://facebook.com"><li><i class="fa fa-facebook"></i></li></a>
						<a href="https://twitter.com"><li><i class="fa fa-twitter"></i></li></a>
		...
		<div class="single-team-member profile">
			<div class="img-box">
			<?php _e( '<img src="' . esc_url( plugins_url( 'img/team4.jpg', __FILE__ ) ) . '" > ' ); ?>
				<?php if($show_hide_social_connection_15 == "true") { ?>	
					<ul class="text-center">
						<a href="https://facebook.com"><li><i class="fa fa-facebook"></i></li></a>
						<a href="https://twitter.com"><li><i class="fa fa-twitter"></i></li></a>
		...
		<div class="single-team-member profile">
			<div class="img-box">
			<?php _e( '<img src="' . esc_url( plugins_url( 'img/team5.jpg', __FILE__ ) ) . '" > ' ); ?>
				<?php if($show_hide_social_connection_15 == "true") { ?>	
					<ul class="text-center">
						<a href="https://facebook.com"><li><i class="fa fa-facebook"></i></li></a>
						<a href="https://twitter.com"><li><i class="fa fa-twitter"></i></li></a>
...
<div class="preview_layout_1">
	<div class="text-shortcode-wrap">
		<span class="shortcode_name">Shortcode for Team Carousel layout 2</span>		
		<input type="text" value="[swe-team layout=2]" readonly onclick="copythis()" class="copy_shortcode">
		<span class="shortcode_info">Use this Shortcode in any post/page/widget </span>
	</div>
	
	<div class="swe-team-layout-2 owl-carousel swe_team_carousel_layout">
	
		<div class="team-member ">
			<a href="#"><?php _e( '<img src="' . esc_url( plugins_url( 'img/team1.jpg', __FILE__ ) ) . '" > '); ?> </a>
		...
		<div class="team-member ">
			<a href="#"><?php _e( '<img src="' . esc_url( plugins_url( 'img/team2.jpg', __FILE__ ) ) . '" > '); ?> </a>
			<div class="member-info">
				<?php if($show_team_name_12 == "true") { ?>	
		...
		<div class="team-member ">
			<a href="#"><?php _e( '<img src="' . esc_url( plugins_url( 'img/team3.jpg', __FILE__ ) ) . '" > '); ?> </a>
			<div class="member-info">
				<?php if($show_team_name_12 == "true") { ?>	
		...
		<div class="team-member ">
			<a href="#"><?php _e( '<img src="' . esc_url( plugins_url( 'img/team4.jpg', __FILE__ ) ) . '" > ' ); ?> </a>
			<div class="member-info">
				<?php if($show_team_name_12 == "true") { ?>	
		...
		<div class="team-member ">
			<a href="#"><?php _e( '<img src="' . esc_url( plugins_url( 'img/team5.jpg', __FILE__ ) ) . '" > ' ); ?> </a>
			<div class="member-info">
				<?php if($show_team_name_12 == "true") { ?>	
...
<div class="preview_layout_1">
	<div class="text-shortcode-wrap">
		<span class="shortcode_name">Shortcode for Team Carousel layout 3</span>		
		<input type="text" value="[swe-team layout=3]" readonly onclick="copythis()" class="copy_shortcode">
		<span class="shortcode_info">Use this Shortcode in any post/page/widget </span>
	</div>
	
	<div class="swe-team-layout-3 owl-carousel swe_team_carousel_layout">
...
<div class="preview_layout_1">
	<div class="text-shortcode-wrap">
		<span class="shortcode_name">Shortcode for Team Carousel layout 4</span>		
		<input type="text" value="[swe-team layout=4]" readonly onclick="copythis()" class="copy_shortcode">
		<span class="shortcode_info">Use this Shortcode in any post/page/widget </span>
	</div>
	
	<div class="swe-team-layout-4 owl-carousel swe_team_carousel_layout">
	
		<div class="single-team-member">
			 <?php _e( '<img src="' . esc_url( plugins_url( 'img/team1.jpg', __FILE__ ) ) . '" class="thumbnail-image" > '); ?>
		...
		<div class="single-team-member">
			 <?php _e( '<img src="' . esc_url( plugins_url( 'img/team2.jpg', __FILE__ ) ) . '" class="thumbnail-image"> '); ?>
			<div class="thumbnail-body">
				<?php if($show_team_name_12 == "true") { ?>	
		...
		<div class="single-team-member">
			 <?php _e( '<img src="' . esc_url( plugins_url( 'img/team3.jpg', __FILE__ ) ) . '" class="thumbnail-image"> '); ?>
			<div class="thumbnail-body">
				<?php if($show_team_name_12 == "true") { ?>	
			...
			<?php } ?>
				...
				<div class="single-team-member">
			 <?php _e( '<img src="' . esc_url( plugins_url( 'img/team4.jpg', __FILE__ ) ) . '" class="thumbnail-image"> '); ?>
			<div class="thumbnail-body">
				<?php if($show_team_name_12 == "true") { ?>	
		...
		<div class="single-team-member">
			 <?php _e( '<img src="' . esc_url( plugins_url( 'img/team5.jpg', __FILE__ ) ) . '" class="thumbnail-image"> '); ?>
			<div class="thumbnail-body">
				<?php if($show_team_name_12 == "true") { ?>	
...
<div class="preview_layout_1">
	<div class="text-shortcode-wrap">
		<span class="shortcode_name">Shortcode for Team Carousel layout 5</span>		
		<input type="text" value="[swe-team layout=5]" readonly onclick="copythis()" class="copy_shortcode">
		<span class="shortcode_info">Use this Shortcode in any post/page/widget </span>
	</div>
	
	<div class="swe-team-layout-5 owl-carousel swe_team_carousel_layout">
		<div class="team_item">
			<?php _e( '<img src="' . esc_url( plugins_url( 'img/team1.jpg', __FILE__ ) ) . '" > '); ?>
...
<div class="preview_layout_1">
	<div class="text-shortcode-wrap">
		<span class="shortcode_name">Shortcode for Team Carousel layout 6</span>		
		<input type="text" value="[swe-team layout=6]" readonly onclick="copythis()" class="copy_shortcode">
		<span class="shortcode_info">Use this Shortcode in any post/page/widget </span>
	</div>
	<div class="swe-team-layout-6 owl-carousel swe_team_carousel_layout">
...
<div class="preview_layout_1">
	<div class="text-shortcode-wrap">
		<span class="shortcode_name">Shortcode for Team Carousel layout 7</span>		
		<input type="text" value="[swe-team layout=7]" readonly onclick="copythis()" class="copy_shortcode">
		<span class="shortcode_info">Use this Shortcode in any post/page/widget </span>
	</div>
	<div class="swe-team-layout-7 owl-carousel swe_team_carousel_layout">
...
<div class="preview_layout_1">
	<div class="text-shortcode-wrap">
		<span class="shortcode_name">Shortcode for Team Carousel layout 8</span>		
		<input type="text" value="[swe-team layout=8]" readonly onclick="copythis()" class="copy_shortcode">
		<span class="shortcode_info">Use this Shortcode in any post/page/widget </span>
	</div>
	<div class="swe-team-layout-8 owl-carousel swe_team_carousel_layout">
...
<div class="preview_layout_1">
	<div class="text-shortcode-wrap">
		<span class="shortcode_name">Shortcode for Team Carousel layout 9</span>		
		<input type="text" value="[swe-team layout=9]" readonly onclick="copythis()" class="copy_shortcode">
		<span class="shortcode_info">Use this Shortcode in any post/page/widget </span>
	</div>
	<div class="swe-team-layout-9 owl-carousel swe_team_carousel_layout">
...
<div class="preview_layout_1">
	<div class="text-shortcode-wrap">
		<span class="shortcode_name">Shortcode for Team Carousel layout 10</span>		
		<input type="text" value="[swe-team layout=10]" readonly onclick="copythis()" class="copy_shortcode">
		<span class="shortcode_info">Use this Shortcode in any post/page/widget </span>
	</div>
	<div class="swe-team-layout-10 owl-carousel swe_team_carousel_layout">
