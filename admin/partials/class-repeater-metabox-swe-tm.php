...
class Swe_Team_Repeater_Meta_Box {
	...
	public function generate_fields( $post ) {
		...
		_e( '<div class="swe-repeater-wrapper">' . $output . '</div>' );
	}
	...
	public function save_post( $post_id ) {
		...
		foreach ( $this->fields as $field ) {
			if ( isset( $_POST[ $field['id'] ] ) ) {
				switch ( $field['type'] ) {
					case 'email':
						$post_field_value = sanitize_email( $_POST[ $field['id'] ] );
						break;
					case 'text':
						$post_field_value = sanitize_text_field( $_POST[ $field['id'] ] );
						break;
				}
				update_post_meta( $post_id, 'team_social_' . $field['id'], $post_field_value );
